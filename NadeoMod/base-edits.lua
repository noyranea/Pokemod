...
if M.TeslaTower then
	...
	table.insert(data.raw["armor"]["modular-armor"].resistances,{type = "electric",percent = 50})
	...
	table.insert(data.raw["technology"]["discharge-defense-equipment"].effects,{type = "unlock-recipe",recipe = "tesla-turret"})
end
