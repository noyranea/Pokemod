...
{
  {
	type = "resource",
	name = "tungsten-ore",
	icon = "__NadeoMod__/graphics/resource/tungsten/ore-icon.png",
    ...
    stages =
    {
      sheet =
      {
	    filename = "__NadeoMod__/graphics/resource/tungsten/ore.png",
		priority = "extra-high",
		width = 38,
		height = 38,
		frame_count = 3,
  ...
  },
  {
	type = "item",
	name = "tungsten-ore",
	icon = "__NadeoMod__/graphics/resource/tungsten/ore.png",
